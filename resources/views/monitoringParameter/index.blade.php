...
<div class="panel panel-default">
    <div class="panel-body">
        <h2>MONITORING PARAMETER <small>Manage</small></h2><hr>
    ...
    var grid = $('#bootgrid').bootgrid({
        ...
        formatters: {
            "commands": function(column, row) {
                return "<a class=\"btn btn-xs btn-default\" href=\"/monitoringParameter/" + row.id + "/edit\"><i class=\"fa fa-edit\"></i></a> " +
