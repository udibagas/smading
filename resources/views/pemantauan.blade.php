...
<div class="row">
    <div class="col-md-3">
        <div class="x_panel">
            <div class="x_title">
                <h4><i class="fa fa-list"></i> PARAMETER</h4>
            </div>
            <div class="x_content">
                <div class="row">
    ...
    <div class="col-md-3">
        <div class="x_panel">
            <div class="x_title">
                <h4><i class="fa fa-th-large"></i> RUANG</h4>
            </div>
            <div class="x_content">
                <div class="row">
                    @foreach ($ruangs as $r)
    ...
    <div class="col-md-3">
        <div class="x_panel">
            <div class="x_title">
                <h4><img src="{{ asset('images/door-open.png')}}" alt="" style="height:20px;"> PINTU</h4>
            </div>
            <div class="x_content">
                <div class="row">
                    @foreach ($pintus as $p)
    ...
    <div class="col-md-3">
        <div class="x_panel">
            <div class="x_title">
                <h4><img src="{{ asset('images/rack-icon-o.png')}}" alt="" style="height:20px;"> RAK</h4>
            </div>
            <div class="x_content">
                <div class="row">
                    @foreach ($raks as $r)
