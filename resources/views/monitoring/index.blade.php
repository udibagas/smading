...
<div class="panel panel-default">
    <div class="panel-body">
        <h2>MONITORING <small>Manage</small></h2><hr>
...
<script type="text/javascript">
    ...
    var btn = '<a href="/monitoring/create" class="btn btn-default"><i class="fa fa-plus"></i> ADD</a>';

    var grid = $('#bootgrid').bootgrid({
        ajax: true, url: '/monitoring',
        ...
        formatters: {
            "commands": function(column, row) {
                return "<a class=\"btn btn-xs btn-default\" href=\"/monitoring/" + row.id + "/edit\"><i class=\"fa fa-edit\"></i></a> " +
