...
<div class="x_panel">
    <div class="x_content">
        <h2>SNMP OID <small>Manage</small></h2>
        <table class="table table-striped table-hover table-bordered" id="bootgrid">
            <thead>
                <tr>
                    ...
                    <th data-column-id="substr_output">Substr Output</th>
...
<script type="text/javascript">
    ...
    var btn = '<a href="{{url('snmpOid/create')}}" class="btn btn-default"><i class="fa fa-plus"></i> TAMBAH</a>';
