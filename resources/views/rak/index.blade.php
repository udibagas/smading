        ...
        <table class="table table-striped table-hover" id="bootgrid">
            <thead>
                <tr>
                    ...
                    <th data-column-id="dimensi">Dimensi (PxLxT dalam cm)</th>
                    <th data-column-id="kapasitas">Kapasitas (Jumlah U)</th>
...
<script type="text/javascript">
    ...
    var btn = '<a href="{{url('rak/create')}}" class="btn btn-default"><i class="fa fa-plus"></i> TAMBAH</a>';
