...
<!-- gauge.js -->
<script src="{{ asset('gentelella/vendors/bernii/gauge.js/dist/gauge.min.js') }}"></script>
...
<!-- Flot plugins -->
<script src="{{ asset('gentelella/production/js/flot/jquery.flot.orderBars.js') }}"></script>
<script src="{{ asset('gentelella/production/js/flot/date.js') }}"></script>
<script src="{{ asset('gentelella/production/js/flot/jquery.flot.spline.js') }}"></script>
<script src="{{ asset('gentelella/production/js/flot/curvedLines.js') }}"></script>
<!-- jVectorMap -->
<script src="{{ asset('gentelella/production/js/maps/jquery-jvectormap-2.0.3.min.js') }}"></script>
